...
const myCommunities = [
  {
    ...
    members: 1234,
    image: "/tech-innovation-abstract.png",
    category: "Technology",
    isPrivate: false,
    unreadPosts: 5,
    role: "Admin",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        >
          <TabsList className="grid w-full grid-cols-3 lg:w-auto">
            <TabsTrigger value="my-communities" className="text-xs sm:text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {myCommunities.map((community) => (
                <Link key={community.id} href={`/community/${community.id}`}>
                  <Card className="group hover:shadow-lg transition-all duration-300 hover:scale-[1.02] border-celestial-blue-50 overflow-hidden h-full">
              ...
              <Card className="border-dashed border-2 border-celestial-blue-50">
                <CardContent className="flex flex-col items-center justify-center py-12 sm:py-16 text-center px-4">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-6 max-w-md">
                    Join or create a community to connect with people who share
                    your interests
                  </p>
          ...
          <TabsContent value="events" className="space-y-6">
            ...
            <div className="flex flex-col gap-4">
              {upcomingEvents.map((event) => (
                ...
                >
                  <Card className="group hover:shadow-lg transition-all duration-300 hover:scale-[1.01] border-celestial-blue-50 overflow-hidden">
            ...
            {upcomingEvents.length === 0 && (
              <Card className="border-dashed border-2 border-celestial-blue-50">
                <CardContent className="flex flex-col items-center justify-center py-12 sm:py-16 text-center px-4">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-6 max-w-md">
                    Join communities to see their upcoming events or create your
                    own
                  </p>
                  <Button
                    variant="outline"
